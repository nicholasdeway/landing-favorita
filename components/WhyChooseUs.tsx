...
export default function WhyChooseUs() {
  ...
  return (
    ...
    >
      ...
      {mounted && isMobile ? (
        /* Static 1-column/2-column grid for Mobile and Tablet (bypassing ScrollStack entirely) */
        <div className="mx-auto max-w-[1080px] w-full">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mt-6">
            {/* Card 1: Precios Justos */}
            <div className="w-full py-8 px-6 rounded-[30px] bg-white border border-brand-teal/15 text-center flex flex-col items-center justify-center relative overflow-hidden min-h-[220px]">
              <span className="absolute top-4 right-5 text-4xl font-black text-brand-teal/8">
                01
              </span>
              <div className="flex flex-col items-center max-w-xl px-2">
                ...
                <p className="mt-2.5 text-sm text-zinc-500 leading-normal">
        ...
        /* Cards Stack/Grid Transition Container (Desktop Version) */
        <div className={`mx-auto transition-all duration-[1000ms] ease-out ${isCompleted ? 'max-w-[1080px]' : 'max-w-[720px]'} relative min-h-[420px]`}>
          ...
          >
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-10">
              {/* Card 1: Precios Justos */}
              <SpotlightCard className="w-full h-80 p-8 md:p-12 rounded-[30px] bg-white border border-brand-teal/15 text-center">
                <span className="absolute top-4 right-5 text-4xl md:text-5xl font-black text-brand-teal/8">
                  01
                </span>
                <div className="flex flex-col items-center max-w-xl px-2">
